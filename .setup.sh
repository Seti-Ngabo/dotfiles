...
# git clone git@github.com:Seti-Ngabo/dotfiles.git
...
git config --global user.email "seti.ngabo@mths.ca"
git config --global user.name "Seti Ngabo"
...
echo "Enter 3 times"
ssh-keygen -t ed25519 -C "seti.ngabo@mths.ca"
